      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
          <div className="flex lg:flex-1">
            ...
            <span className="text-black font-semibold">  name/logo</span>
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              ...
              <a href="https://www.overleaf.com/learn" className="font-semibold text-indigo-600">
          ...
          <div className="text-center">
            ...
            The Simplest Way to Build Your LaTeX Resume
            </h1>
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
            Create a professional, ATS-friendly LaTeX resume in minutes with AI-powered templates designed to make you stand out
            </p>
